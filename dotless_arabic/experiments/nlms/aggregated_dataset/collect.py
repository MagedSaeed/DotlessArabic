...
from dotless_arabic.experiments.nlms.news_dataset.collect import (
    collect_dataset as collect_news_dataset,
)
from dotless_arabic.experiments.nlms.poems_dataset.collect import (
    collect_dataset as collect_poems_dataset,
)
from dotless_arabic.experiments.nlms.quran_dataset.collect import (
...
from dotless_arabic.experiments.nlms.wikipedia_dataset.collect import (
