...
from dotless_arabic.datasets.aggregated.collect import (
    ...
    collect_raw_dataset as collect_raw_aggregated_dataset,
)
...
COLLECT_RAW_DATASET = {
    "quran": collect_raw_quran_dataset,
    "sanadset_hadeeth": collect_raw_sanadset_hadeeth_dataset,
    "poems": collect_raw_poems_dataset,
    "news": collect_raw_news_dataset,
    "wikipedia": collect_raw_wikipedia_dataset,
    "aggregated": collect_raw_aggregated_dataset,
}
